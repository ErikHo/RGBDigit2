...
This software is a fine tuning of the work of Ralph Crützen 2015 (www.rgbdigit.com). The header
...
- The array containing the color values for the pixel string has been removed. The underlying 
  ...
  at lower brightness levels the colorvalues in the array get changed due to truncation effects.
